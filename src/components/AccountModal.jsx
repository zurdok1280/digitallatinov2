...
export default function AccountModal({ onClose }) {
  ...
  const isCancelled = subscriptionData?.status
    ?.toLowerCase()
    .includes("cancela");
  const isActive =
    subscriptionData?.status?.toLowerCase() === "active" ||
    subscriptionData?.status?.toLowerCase() === "activo";
    ...
    >
      ...
      >
        ...
        <div className="login-header-group" style={{ marginBottom: "1.5rem" }}>
          <div
            className="login-music-icon-wrapper"
            style={{
              width: "3.5rem",
              height: "3.5rem",
              marginBottom: "0.5rem",
          ...
          >
            <User
              style={{ width: "1.8rem", height: "1.8rem", color: "#ffffff" }}
            />
          </div>
          <h2
                  ...
                  <div style={{ marginTop: "auto" }}>
                    {!showPasswordForm ? (
                      ...
                      >
                        ...
                        {passwordSuccess && (
                          <p style={{ color: "#34d399", fontSize: "0.8rem" }}>
                            {passwordSuccess}
                          </p>
                        )}
                ...
                >
                  {!showConfirmCancel ? (
                    ...
                    >
                      ...
                      >
                        ¿Seguro que deseas cancelar? Tu acceso continuará hasta
